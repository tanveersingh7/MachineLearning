...
model1 = Sequential()
model1.add(Conv2D(20, kernel_size=(3,3), activation='linear', input_shape = input_shape))
model1.add(BatchNormalization())
model1.add(Activation(LReLU))
model1.add(MaxPooling2D(pool_size = (3,3), strides = 1))
